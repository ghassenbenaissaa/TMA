 ...
 */
final class Version20240729144423 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE add_friend ADD etat VARCHAR(255) NOT NULL, ADD notification INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE add_friend DROP FOREIGN KEY FK_B930ED4D9D86650F');
        $this->addSql('ALTER TABLE add_friend DROP etat, DROP notification');
