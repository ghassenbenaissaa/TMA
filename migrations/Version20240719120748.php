 ...
 */
final class Version20240719120748 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE add_friend (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, user_id2 INT NOT NULL, INDEX IDX_B930ED4D9D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
