 ...
 */
final class Version20240719121528 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE add_friend ADD confirmation INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE add_friend DROP FOREIGN KEY FK_B930ED4D9D86650F');
        $this->addSql('ALTER TABLE add_friend DROP confirmation');
